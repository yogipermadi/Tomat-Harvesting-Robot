    ...
    for r in results:
        ...
        for box in boxes:
            if box.conf[0]>=0.5:
                ...
                distancei = (2 * 3.14 * 180) / (w + h * 360) * 3 + 5
                ...
                cv2.putText(img, f"{classNames[cls]} {box.conf}", org, font, fontScale, color, thickness)
                cv2.putText(img, f"{distancei} cm", [50,100], font, fontScale, color, thickness)
                if(center_x>330):
